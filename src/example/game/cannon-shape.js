...
class ConnonShape {
    static CreateBox(object3d) {
        const box3 = new THREE.Box3();
        box3.expandByObject(object3d);//计算模型包围盒
    ...
    static CreateConvexPolyhedron2(geometry) {
